...
UPDATE espece set image="Bufo_bufo.jpg" where id=1;
UPDATE espece set image="rhinella_marina.jpg" where id=2;
UPDATE espece set image="oophaga pumilio.jpg" where id=3;
UPDATE espece set image ="dendrobates tinctorius.jpg" where id=4;
UPDATE espece set image="hyla arborea.jpg" where id=5;
UPDATE espece set image ="litoria caerulea.JPG" where id=6;
UPDATE espece set image ="leptodactylus fuscus.jpg" where id=7;
UPDATE espece set image = "eleutherodactylus coqui.JPG" where id=8;
UPDATE espece set image ="gastrophryne carolinensis.jpg" where id=9;
UPDATE espece set image= "kaloula pulchra.jpg" where id=10;
UPDATE espece set image ="rana temporaria.jpg" where id=11;
UPDATE espece set image ="lithobates catesbeianus.jpg" where id=12;
UPDATE espece set image ="polypedates leucomystax.jpg" where id=13;
UPDATE espece set image ="rhacophorus nigropalmatus.jpg" where id=14;
UPDATE espece set image ="sooglossus thomasseti.jpeg" where id=15;
UPDATE espece set image ="pelophylax perezi.jpg" where id=16;
UPDATE espece set image ="pelophylax ridibundus.jpg" where id=17;
UPDATE espece set image ="pelophylax kl. grafi.jpg" where id=18;