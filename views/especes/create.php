...
<div class="container">
        ...
        <form action="index.php?page=especes&action=<?php echo $action; echo (isset($id)) ? '&id='.$id : '';?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <option value="<?php echo $esps->id; ?>"<?php echo ($modifesp->id === $esps->id)? 'selected':''?>><?php echo $esps->codeStatut;?> - <?php echo $esps->statut;?></option>
                <?php endforeach ?>
                </select>
            </div>
            <div class="mb-3">
                ...
                <option value="<?php echo $esp->id; ?>"<?php echo ($modifesp->id === $esp->id)? 'selected':''?>><?php echo $esp->nomFamille;?></option>
                <?php endforeach ?>
                </select>
            </div>
            <div class="mb-3">
