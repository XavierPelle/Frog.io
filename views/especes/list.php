                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><strong>Taille:</strong>
                                <?= $espece->taille ?>
                            </li>
                            <li class="list-group-item"><strong>Altitude:</strong>
                                <?= $espece->altitude ?>
                            </li>
                            <li class="list-group-item"><strong>Famille:</strong>
                                <?= $familles[$espece->id] ?>
                            </li>
                            <li class="list-group-item"><strong>Statut Conservation:</strong>
                                <?= $statuts[$espece->id] ?>
                            </li>
                        </ul>
                        <?php if (isset($_SESSION['logged']) && $_SESSION['logged']) { ?>
                            <a href="index.php?page=especes&action=update&id=<?= $espece->id ?>"
                                class="btn btn-primary">Modifier</a>
                            <form method="post" action="index.php?page=especes&action=delete"
